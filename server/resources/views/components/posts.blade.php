...
<div class="my-5 scroll-m-16" id="post-thread-photos">
    <h3 class="text-xl ps-5 py-1 border-s-4 border-indigo-500">Post a new thread photos</h3>
    <ul class="mt-5 flex flex-col gap-2">
        <li>URL: <span class="text-indigo-500 ms-2 px-2 py-1 bg-gray-100 rounded">/posts/{postId}/files</span></li>
        <li>Method: <span class="text-orange-500 ms-2 px-2 py-1 bg-gray-100 rounded">POST</span></li>
        <li>
            Body: 
            <ul class="ms-5">
        ...
        <pre class="p-4 rounded-lg"> 
            <code class="language-json">
                {{ $documentation->store_thread_photo }} 
            </code>
        </pre>
    </ul>
</div>

<div class="my-5 scroll-m-16" id="like-thread">
    <h3 class="text-xl ps-5 py-1 border-s-4 border-indigo-500">Like a thread</h3>
    <ul class="mt-5 flex flex-col gap-2">
        <li>URL: <span class="text-indigo-500 ms-2 px-2 py-1 bg-gray-100 rounded">/posts/{id}/like</span></li>
        <li>Method: <span class="text-orange-500 ms-2 px-2 py-1 bg-gray-100 rounded">POST</span></li>
        <li>Response: </li>
        <pre class="p-4 rounded-lg"> 
            <code class="language-json">
                {{ $documentation->like_post }} 
            </code>
        </pre>
    </ul>
</div>

<div class="my-5 scroll-m-16" id="dislike-thread">
    <h3 class="text-xl ps-5 py-1 border-s-4 border-indigo-500">Dislike a thread</h3>
    <ul class="mt-5 flex flex-col gap-2">
        <li>URL: <span class="text-indigo-500 ms-2 px-2 py-1 bg-gray-100 rounded">/posts/{id}/dislike</span></li>
        <li>Method: <span class="text-orange-500 ms-2 px-2 py-1 bg-gray-100 rounded">POST</span></li>
        <li>Response: </li>
        <pre class="p-4 rounded-lg"> 
            <code class="language-json">
                {{ $documentation->dislike_post }} 
            </code>
        </pre>
    </ul>
</div>
...
<div class="my-5 scroll-m-16" id="delete-thread-photo">
    <h3 class="text-xl ps-5 py-1 border-s-4 border-indigo-500">Delete post photo</h3>
    <ul class="mt-5 flex flex-col gap-2">
        <li>URL: <span class="text-indigo-500 ms-2 px-2 py-1 bg-gray-100 rounded">/posts/{postId}/files/{fileId}</span></li>
        <li>Method: <span class="text-red-500 ms-2 px-2 py-1 bg-gray-100 rounded">DELETE</span></li>
        <li>Response: </li>
        <pre class="p-4 rounded-lg"> 
            <code class="language-json">
                {{ $documentation->delete_thread_photo }} 
            </code>
        </pre>
    </ul>
</div>
